...
//        return userMapper.updateHeader(userId, headerUrl);
    ...
    public void updatePasswordById(String password, String newPassword, String confirmPassword) {
        User user = hostHolder.getUser();
        int id = user.getId();
        String password1 = user.getPassword();
        System.out.println(password1);
        System.out.println(password);
        if (password1.equals(password) && newPassword.equals(confirmPassword)) {
